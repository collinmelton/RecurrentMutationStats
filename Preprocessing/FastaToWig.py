...
def getOptions():
    ...
    parser.add_option("--I", dest="input", help = "path plus input file prefix",
                      metavar = "FILE", type = "string", default = "/srv/gs1/projects/snyder/collinmelton/bundle/2.3/b37/d5/hs37d5.fa")#"/Users/cmelton/Documents/GenomeReference/test.fasta") #human_g1k_v37.fasta")#
    parser.add_option("--O", dest="output", help="path and name of output file",
                      metavar="FILE", type="string", default="/srv/gsfs0/projects/snyder/collinmelton/RecurrentMutationDecectionAlgorithm/WholeGenomeWigs/hs37d5.triplets.")#"/srv/gs1/projects/snyder/collinmelton/bundle/2.3/b37/d5/hs37d5.triplets.") # "/Users/cmelton/Documents/GenomeReference/test.triplets.")#
