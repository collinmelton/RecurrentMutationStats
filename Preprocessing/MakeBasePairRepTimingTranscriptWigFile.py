...
def getOptions():
    ...
    parser.add_option("--D", dest = "WigDirectory", help = "path to directory of reference wig files"+
                      "concurrently", metavar = "FILE", default = "/srv/gsfs0/projects/snyder/collinmelton/RecurrentMutationDecectionAlgorithm/Wigs/", type = "string" )#"/Users/cmelton/Documents/Lab/SnyderLab/LocalMutationRate/WigFiles", type = "string")
...
def runMain():
    ...
    print "about to run"
    run(options.inputFile, cExonFiles, cIntronFiles, ncExonFiles, ncIntronFiles, os.path.join(directory+"Other/", "summary."+options.Chrom+".wig.gz"), -4, 83, 87, options.outputFile, epigenomeFiles)
